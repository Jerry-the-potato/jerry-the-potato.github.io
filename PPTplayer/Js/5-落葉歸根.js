...
var SceneDE = new Image();
var SceneFG = new Image();
var SceneH = new Image();
SceneA.src = "../images/background/5-A.jpg";
SceneB.src = "../images/background/5-B.jpg";
SceneC.src = "../images/background/5-C.jpg";
SceneDE.src = "../images/background/5-DE.jpg";
SceneFG.src = "../images/background/5-FG.jpg";
SceneH.src = "../images/background/5-H.jpg";
...
function Initial() {
    ...
    for (N = 0; N < 165 * 3; N = N + 2) {
        ...
        FallenImg2.Random(0 + (N + Math.random() * 1) * 1000 / 3, 4, -250, 750, 0, 700,30,50,0.5,1);
        FallenImg2.Random(0 + (N + Math.random() * 1) * 1000 / 3, 4, 750, 1750, 0, 700,30,50,0.5,1);
...
function AutoUpdate() {
    ...
    if (Scene == 'A') {
        ...
        context.drawImage(SceneDE, 0, 0, 1520, 840, 0, 0, 1520, 840);
    }
    else if (Scene == 'FG') {
        context.drawImage(SceneFG, 0, 0, 1520, 840, 0, 0, 1520, 840);
    }
    else if (Scene == 'H') {
    ...
    if (TheaKey3 == 1) {
        ...
        for (N = 0; N <FloatImg3.ms.length; N++) {
            ...
            if (delms > 1000) {
                ...
                if (Scene == 'C') { WindX = 0.15; WindY = 0.03; }
                ...
                switch (FallenImg2.pic[N] * 1) { // 陷阱:如果pic資料型態為字串，那case取數字就會出問題
                    case 1:
                        context.drawImage(image1, 0, 0, 300, 300, -C, -C, size, size); //畫出來囉~
                        break;
                    case 2:
                        context.drawImage(image2, 0, 0, 300, 300, -C, -C, size, size); //畫出來囉~
                        break;
                    case 3:
                        context.drawImage(image3, 0, 0, 300, 300, -C, -C, size, size); //畫出來囉~
                        break;
                    case 4:
                        context.drawImage(image4, 0, 0, 300, 300, -C, -C, size, size); //畫出來囉~
                        break;
                }
                if (BubbleKey4 == 1) {
                    context.beginPath();
    ...
    if (FallKey2 == 1) {
        ...
        for (N = 0; N < FallenImg2.ms.length; N++) {
            ...
            if (delms > 200) {
                ...
                if (Scene == 'A') { WindX = 0.15; WindY = 0; }
                else if (Scene == 'B') { WindX = -0.3; WindY = 0.15; }
                else if (Scene == 'DE') { WindX = 0.3; WindY = 0.15;}
                else if (Scene == 'FG') { WindX = 0; WindY = 0; }
                else if (Scene == 'H') { WindX = 0.1; WindY = 0;}
...
for (n = 0; n <= 5; n++) { 
    AnimeLyric.Build(n, 'oneByOne', 650, 'manual', 14000);
}
for (n = 6; n <= 8; n++) { //遠離家鄉
    AnimeLyric.Build(n, 'oneByOne', 400, 'manual', 7000);
}
for (n = 9; n <= 9; n++) { //我的愛
    AnimeLyric.Build(n, 'oneByOne', 900, 'manual', 10000, 'OUT');
}
for (n = 10; n <= 12; n++) { //舉頭望+命運
    AnimeLyric.Build(n, 'oneByOne', 650, 'manual', 14000);
}
for (n = 13; n <= 15; n++) { //遠離家鄉
    AnimeLyric.Build(n, 'oneByOne', 400, 'manual', 7000);
}
for (n = 16; n <= 16; n++) { //我的愛
    AnimeLyric.Build(n, 'oneByOne', 900, 'manual', 10000, 'OUT');
}
for (n = 17; n <= 19; n++) { //遠離家鄉
    AnimeLyric.Build(n, 'oneByOne', 400, 'manual', 7000);
}
for (n = 20; n <= 20; n++) { //Solo
    AnimeLyric.Build(n, 'oneByOne', 250, 'manual', 37000, 'OUT');
}
for (n = 21; n <= 21; n++) { //Solo
    AnimeLyric.Build(n, 'oneByOne', 500, 'manual', 26000, 'OUT');
}
for (n = 22; n <= 22; n++) { //Solo
    AnimeLyric.Build(n, 'oneByOne', 200, 'manual', 24000, 'OUT');
}
for (n = 23; n <= 23; n++) { //Solo
    AnimeLyric.Build(n, 'oneByOne', 500, 'manual', 8000, 'OUT');
}
//時間參數
...
function Start() {
    ...
    iframe.setAttribute('src', "https://u.pcloud.link/publink/show?code=XZMbwmXZtbaFHU6fF2596xJNXcX6oh2uvgfX");
