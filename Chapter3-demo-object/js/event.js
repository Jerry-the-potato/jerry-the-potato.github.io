...
let isWinding = false;
let a = 0, b = 0;
let myTree = new Tree(undefined, window.innerWidth, window.innerHeight*2, window.innerHeight/3, -90, 10);
...
function Recreate(e){
    ...
    myTree = new Tree(undefined, window.innerWidth, window.innerHeight*2, window.innerHeight/3, -90, 10);
}
